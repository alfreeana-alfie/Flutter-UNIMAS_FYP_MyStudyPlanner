...
class SysCalendar extends StatefulWidget {
  @override
  _SysCalendarState createState() => _SysCalendarState();
}

class _SysCalendarState extends State<SysCalendar> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
        appBar:
            AppBar(backgroundColor: Colors.blue[500], title: Text('Calendar')),
        body: SfCalendar(
...
List<Appointment> getAppointments() {
  ...
  final DateTime startTime =
      DateTime(2021, 05, 03, 12, 0, 0);
  final DateTime endTime = startTime.add(const Duration(hours: 2));

  final DateTime startTime02 =
      DateTime(2021, 05, 03, 14, 0, 0);
