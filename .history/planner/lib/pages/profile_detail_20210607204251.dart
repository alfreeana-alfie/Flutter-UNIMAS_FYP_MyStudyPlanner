  ...
  Future getAddress() async {
    ...
    if (response.statusCode == 200) {
      ...
      if (verifyData.status == "SUCCESS") {
        ...
        if (this.mounted) {
          setState(() {
            addressController.text = addressData.name;
            otherAddressController.text = addressData.email;
            postcodeController.text = addressData.phone_no;
            matricNoController.text = addressData.matric_no;

            name = addressData.name;
            email = addressData.email;
            phoneNo = addressData.phone_no;
            matricNo = addressData.matric_no;
            imageURL = addressData.image;
          });
        }
      } else {
        print('FAILED');
