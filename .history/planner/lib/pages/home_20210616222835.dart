...
class _HomepageState extends State<Homepage> {
  ...
  Widget buildNews() {
    return Container(
      ...
      //                   SizedBox(
      //                     width: 250,
      //                     child: Text(dataNewsList[index].title,
      //                         maxLines: 1,
      //                         overflow: TextOverflow.ellipsis,
      //                         softWrap: false,
      //                         style: GoogleFonts.openSans(
      ...
      //                   SizedBox(
      //                     width: 250,
      //                     child: Text(dataNewsList[index].description,
      //                         maxLines: 1,
      //                         overflow: TextOverflow.ellipsis,
      //                         softWrap: false,
      //                         style: GoogleFonts.openSans(
      ...
      // ),
      child: AnimatedList(
        initialItemCount: dataNewsList.length,
        itemBuilder: (context, index, animation){
          return SlideTransition(position: animation.drive(myTween())
        },
      )
    );
  }
