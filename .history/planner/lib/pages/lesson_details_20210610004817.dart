...
class _LessonDetailsState extends State<LessonDetails> {
  ...
  Widget buildDayTime() {
    return Container(
      child: Column(
        children: [
          Container(
            child: isDay == true ? buildDayPicker() : daySelected()
          ),
          timeRangePicker(),
        ],
      ),
  ...
  Widget buildTimePicker(String frame, String time) {
    return Center(
      child: Padding(
      ...
      child: isEnabled == true
          ? TimeRange(
              ...
              toTitle: Text(
                'To',
                style:
                    GoogleFonts.openSans(fontSize: 14, color: Colors.black45),
              ),
              titlePadding: 15,
              textStyle:
          ...
          : Column(
              children: [
                buildTimePicker('START', _startTimeSTR),
                buildTimePicker('END', _endTimeSTR),
              ],
            ),
    );
  }
